...
class Server:
    ...
    def run(self):
        logging.warning(f"server running on ip address {self.ipinfo}, process pool size is {self.pool_size}")
...
def main():
    ...
    parser.add_argument('--pool-size', type=int, default=5, help='Thread pool size (default: 5)') # karena nilai tengah pool size
